    ...
    <div class="col-lg-12">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="text" name="telefone1" id="telefone1" class="form-control telefone @error('telefone1') is-invalid @enderror" value="{{ old('telefone1') }}">
                @error('telefone1')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="telefone2" id="telefone2" class="form-control telefone" value="{{ old('telefone2') }}">
            </div>
            <div class="col-md-4">
                <label for="contato"><strong>Contato</strong></label>
                <input type="text" name="contato" id="telefone2" class="form-control telefone" value="{{ old('contato') }}">
            </div>
        </div>
