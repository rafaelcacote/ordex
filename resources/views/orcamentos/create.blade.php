    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form class="row g-3 cadastro" method="POST" action="{{ route('orcamentos.store') }}" novalidate>
                    @csrf

                    <div class="pagetitle">

                        <button type="submit" class="btn btn-success salvar"><i class="bi bi-save2 me-1"></i> SALVAR</button>
                        <a href="{{ route('orcamentos.index') }}" class="btn btn-danger cancelar"><i
                                class="bi bi-backspace me-1"></i> CANCELAR</a>
                        <h1>Cotação - Adicionar</h1>
                        <nav>
                            <ol class="breadcrumb">
