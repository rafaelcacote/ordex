                    ...
                    <div class="row mb-3 mt-4">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="codigo" id="codigo" class="form-control" value="{{ $orcamento->fornecedor_id }}" readonly>
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input type="text" name="nome" id="nome" class="form-control" value="{{ $orcamento->fornecedor->nome }}" readonly>
                            </div>
                        </div>
                        <div class="row mb-3 mt-4">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="prazo" id="prazo" class="form-control" value="{{ $orcamento->prazo }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="data"><strong>Data</strong></label>
                                    <input type="date" name="data" id="data" class="form-control" value="{{ $orcamento->data }}">
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="tab-pane fade" id="bordered-justified-profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="table-responsive mt-4">
                                    ...
                                    <tr data-produto-id="{{ $item->produto_id }}">
                                        ...
                                        <td>
                                            <button class="btn btn-warning btn-sm add-observacao" data-id="{{ $item->produto_id }}">
                                                <i class="bi bi-pencil"></i> Adicionar Observação
                                            </button>
                        ...
                        <div class="foote-class">
                            <span class="font-bold">Quant. Itens:<span id="total-quantidade" class="font-bold">{{ $orcamento->itensOrcamento->count() }}</span> </span>
                            <br>
                            <span class="font-bold">Total dos Itens: R$<span id="total-valores" class="font-bold">{{ $orcamento->total_orcamento }}</span></span>
                        </div>
                    </div>
                  </div>
...
<script>
    ...
    const totalValores = document.getElementById('total-valores').textContent
        ...
        const orcamentoId = document.getElementById('orcamento_id').value; // Supondo que você tenha esse campo no seu form
