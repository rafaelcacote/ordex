                            ...
                            <tbody id="itens-list">
                                @foreach (session('itens_pedido', []) as $item)
                                    <tr data-produto-id="{{ $item->produto_id }}">
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm add-observacao"
    ...
    <script>
        ...
        quantidadeprodutoInput.addEventListener('keydown', function(event) {
            if (event.key === 'Enter') {
               ...
               <td>
                        <button class="btn btn-warning btn-sm add-observacao" data-id="${produtoId}" data-bs-toggle="modal" data-bs-target="#observacaoModal">
                            <i class="bi bi-pencil"></i>
                        </button>
                        <button class="btn btn-danger btn-sm delete-item">
                            <i class="bi bi-trash"></i>
