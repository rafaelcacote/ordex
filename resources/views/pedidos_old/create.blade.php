                        ...
                        <div class="tab-pane fade" id="bordered-justified-profile" role="tabpanel"
                            ...
                            <div class="row mb-3 mt-4">
                                ...
                                <div id="produto-table-container"
                                    style="display: none; position: absolute; top: 100%; left: 0; max-height: 400px; overflow-y: auto; background: #fff; border: 1px solid #ccc; width: calc(55% - 20px); z-index: 100;">
                                    <table class="table table-hover mb-0">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
