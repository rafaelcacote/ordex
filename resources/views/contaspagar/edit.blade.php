    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form class="row g-3 cadastro" method="POST" action="{{ route('contaspagar.update', $contaPagar->id) }}" novalidate>
                    @csrf
                    @method('PUT') <!-- Ou @method('PATCH') dependendo da sua convenção -->
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="descricao" id="descricao"
                                        class="form-control @error('descricao') is-invalid @enderror" value="{{ old('descricao', $contaPagar->descricao) }}">
                                    @error('descricao')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="documento" id="documento"
                                        class="form-control @error('documento') is-invalid @enderror" value="{{ old('documento', $contaPagar->documento) }}">
                                    @error('documento')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data" id="data" class="form-control"
                                            value="{{ old('data', $contaPagar->data) }}" autocomplete=off>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3" >
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="valor_quitacao" id="valor_quitacao"
                                        class="form-control moeda @error('valor_quitacao') is-invalid @enderror" value="{{ old('valor_quitacao', $contaPagar->valor_quitacao) }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="multa" id="multa"
                                        class="form-control moeda @error('multa') is-invalid @enderror" value="{{ old('multa', $contaPagar->multa) }}">
                                    @error('multa')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="juros" id="juros"
                                        class="form-control moeda @error('juros') is-invalid @enderror" value="{{ old('juros', $contaPagar->juros) }}">
                                    @error('juros')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-4" >
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="vencimento" id="vencimento" class="form-control"
                                            value="{{ old('vencimento', $contaPagar->vencimento) }}" autocomplete=off>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="parcela"><strong id="parcelaLabel">Parcela</strong></label>
                                    <input type="text" name="parcela" id="parcela"
                                        class="form-control @error('parcela') is-invalid @enderror" value="{{ old('parcela', $contaPagar->parcela) }}">
                                    @error('parcela')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select name="status" id="status" class="form-select @error('status') is-invalid @enderror" onchange="toggleFields()">
                                        <option value="Pago" {{ old('status', $contaPagar->status) == 'Pago' ? 'selected' : '' }}>Pago</option>
                                        <option value="Pendente" {{ old('status', $contaPagar->status) == 'Pendente' ? 'selected' : '' }}>Pendente</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
