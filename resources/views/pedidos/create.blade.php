                            ...
                            <div class="row mb-3 mt-4">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="codigo" id="codigo" class="form-control @error('codigo') is-invalid @enderror" value="{{ old('codigo') }}" autocomplete="off">
                                        @error('codigo')
                                ...
                                <div class="col-md-10 mt-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nome" id="nome" class="form-control" value="{{ old('nome') }}" autocomplete="off">
                                        <div class="alert alert-warning alert-dismissible fade show invalid-feedback mt-3"  id="fornecedor-error" role="alert" style="display: none;">
                                            <i class="bi bi-exclamation-triangle me-1"></i>
                                            Fornecedor não encontrado!
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                        <!-- Aqui vai aparecer a tabela com fornecedores -->
                                        <div id="fornecedor-table-container" style="display: none; position: absolute; max-height: 300px; overflow-y: auto; background: #fff; border: 1px solid #ccc;">
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="prazo" id="prazo" class="form-control @error('prazo') is-invalid @enderror" value="{{ old('prazo') }}" autocomplete="off">
                                        @error('prazo')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="data" id="data" class="form-control" value="{{ old('data') }}" autocomplete=off>
                                    </div>
                                </div>
                          ...
                          <div class="tab-pane fade" id="bordered-justified-profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="row mb-3 mt-4">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="codigo_produto" id="codigo_produto" class="form-control" value="{{ old('codigo_produto') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nome_produto" id="nome_produto" class="form-control" value="{{ old('nome_produto') }}" autocomplete="off">
                                        ...
                                        <div class="alert alert-warning" id="erro-item" style="display: none; margin-top: 10px;">
                                            <i class="bi bi-exclamation-triangle me-1"></i> Nenhum Produto selecionado. Por favor, escolha um produto.
                                        </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="estoque_produto" id="estoque_produto" class="form-control" value="{{ old('estoque') }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="alert alert-warning" id="erro-quantidade" style="display: none; margin-top: 10px;">
                            ...
                            <div class="table-responsive mt-4">
                                ...
                                <div class="foote-class">
                                    <span class="font-bold">Quant. Itens:<span id="total-quantidade" class="font-bold">0</span> </span>

                                    <br>
                                    <span class="font-bold">Total dos Itens: R$<span id="total-valores" class="font-bold">0.00</span></span>
                                    ...
                                    <textarea class="form-control " id="observacao" name="observacao"value="{{ old('observacao') }}" autocomplete=off>  </textarea>
                                                  ...
                                                  <div class="container mt-5">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-1" id="parcela_container" style="display:none;">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="numero_parcelas" id="numero_parcelas" class="form-control" min="1" value="2" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-1" id="dias_container" style="display:none;">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="numero_dias" id="numero_dias" class="form-control" min="1" value="30" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="valor_recebido" id="valor_recebido" class="form-control" autocomplete="off">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="valor_total" id="valor_total" class="form-control"  autocomplete="off">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="resultados" style="display: none;">
                                                        ...
                                                        <button type="button" class="btn btn-danger mt-3" id="limpar-tudo">Limpar Tudo</button>
                                                    </div>
                                                </div>
                ...
                if (codigo) {
                    ...
                    fetch(`{{ route('buscar.fornecedor', '') }}/${codigo}`)
                        ...
                        .catch(error => {
                            ...
                            fornecedorError.style.display = 'block'; // Exibir erro em caso de falha na requisição
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        nomeInput.addEventListener('input', function() {
            ...
            if (termo.length >= 3) { // Inicia a busca apenas se o termo tiver pelo menos 3 caracteres
                fetch(`{{ route('buscar.fornecedor.nome', '') }}`)
                    .then(response => response.json())
                    .then(data => {
                        ...
                        if (data.length > 0) {
                            ...
                            data.forEach((fornecedor, index) => {
                                ...
                                tr.addEventListener('click', function() {
                                    ...
                                    codigoInput.value = fornecedor.id; // Preenche o código (ID)
                                    nomeInput.setAttribute('data-id', fornecedor.id); // Armazena o ID
                            ...
                            fornecedorTableContainer.style.display = 'none'; // Se não houver resultados, esconde a tabela
                        }
                    })
                    .catch(error => {
                ...
                fornecedorTableContainer.style.display = 'none'; // Esconde a tabela se o termo for menor que 3 caracteres
            }
        });
...
<script>
    ...
    const itensList = document.getElementById('itens-list'); // Supondo que você tenha essa tabela para os itens inseridos
    ...
    function excluirItem(event) {
        ...
        if (deleteButton) {
            ...
            const valorTotalItem = parseFloat(row.querySelector('td:nth-child(5)').textContent); // Captura o valor total do item
