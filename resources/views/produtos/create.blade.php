    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <form class="row g-3 cadastro" method="POST" action="{{ route('produtos.store') }}" novalidate>
                    @csrf

                    <div class="pagetitle">

                        <button type="submit" class="btn btn-success salvar"><i class="bi bi-save2 me-1"></i> SALVAR</button>
                        <a href="{{ route('produtos.index') }}" class="btn btn-danger cancelar"><i
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="estoque" id="estoque" class="form-control @error('estoque') is-invalid @enderror" value="{{ old('estoque') }}">
                    @error('estoque')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" name="medida" id="medida" step="0.01" class="form-control" value="{{ old('medida') }}">
                </div>
            </div>
        </div>
